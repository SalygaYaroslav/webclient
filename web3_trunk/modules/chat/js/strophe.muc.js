...
(function () {
    ...
    XmppRoom = (function () {
        ...
        XmppRoom.prototype.multipleInvites = function (receivers, reason) {
            return this.client.multipleInvites(this.name, receivers, reason, this.password);
        };
        ...
        XmppRoom.prototype.clearUnreadCount = function () {
            this.unreadcount = 0;
        ...
        XmppRoom.prototype._roomRosterHandler = function (pres) {
            var data, handler, id, newnick, nick, _ref, object = {};
            data = XmppRoom._parsePresence(pres);
            object.status = data.status || "";
            nick = object.nick = data.nick;
            newnick = object.newnick = data.newnick || null;
            switch (data.type) {
                case 'error':
                    return true;
                case 'unavailable':
                    ...
                    $(document).trigger('roster.leave.' + this.name, object);
                    break;
                default:
                    if (this.roster[nick]) {
                    ...
                    $(document).trigger('roster.join.' + this.name, object);
            }
